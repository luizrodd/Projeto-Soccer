        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResultTeamOne = table.Column<int>(type: "int", maxLength: 2, nullable: false),
                    ResultTeamTwo = table.Column<int>(type: "int", maxLength: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Teams_Games_TeamOneId",
                        column: x => x.TeamOneId,
                        principalTable: "Games",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Teams_Games_TeamTwoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_TeamOneId",
                table: "Teams",
                column: "TeamOneId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Teams_TeamTwoId",
                table: "Teams",
                column: "TeamTwoId",
                unique: true);
        }
